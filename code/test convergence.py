...
##while repCount <= 30:
extraBridges=60
print(repCount,"th replication")
stop = True
while stop and extraBridges <=624:
    restoreParams()
    openlog()
    initAgents()
    getVertices()
    print("trail for ",extraBridges," extra bridges")
    file_log.flush()
    while sbStillGotMoney and count_round <= 1200:
        play()
        count_round += 1
    convergeTest()
    if stop:
        extraBridges += 1
print(extraBridges+1,"bridges to converge")
for agent in agentList:
